...
public interface DigitalSignatureProcessor {
     ...
     *
     * @param argSignedConetnt Контент, на котором проверяется подпись.
     ...
     *                                                                       Кроме того, выбрасывается, если какой-либо из аргументов - null.
     */
    X509Certificate validatePKCS7Signature(InputStream argSignedConetnt, byte[] argSignature) throws SignatureProcessingException, SignatureValidationException;
